...
namespace Desafio.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            { 
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddClaimAsync(user, new Claim("4Letras", Input.Letras));
                    await _userManager.AddClaimAsync(user, new Claim("Email", Input.Email));

                    var scrum = new ScrumMaster();
                    scrum.Id = 0;
                    scrum.Nome = Input.Nome;
                    scrum.Email = Input.Email;
                    scrum.Letras = scrum.Letras;
